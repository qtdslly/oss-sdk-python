...
class TestUtils(unittest.TestCase):
    def test_lazy_call(self):
        with mock.patch('oss.utils.import_module') as importer:
    ...
    def test_import_module(self):
        module = utils.import_module('oss.s3.transfer')
        assert module.__name__ == 'oss.s3.transfer'
