...
from oss.dynamodb.conditions import Attr, Key
from oss.dynamodb.transform import (
...
class TestDynamoDBHighLevelResource(unittest.TestCase):
    ...
    def test_instantiation(self):
        ...
        with mock.patch(
            'oss.dynamodb.transform.TransformationInjector'
        ) as mock_injector:
            with mock.patch(
                'oss.dynamodb.transform.DocumentModifiedShape.'
