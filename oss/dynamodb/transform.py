...
from oss.compat import collections_abc
from oss.docs.utils import DocumentModifiedShape
from oss.dynamodb.conditions import ConditionBase, ConditionExpressionBuilder
from oss.dynamodb.types import TypeDeserializer, TypeSerializer
...
class DynamoDBHighLevelResource:
    def __init__(self, *args, **kwargs):
        ...
        key_expression_shape_docs = DocumentModifiedShape(
            'KeyExpression',
            new_type=(
                'condition from :py:class:`oss.dynamodb.conditions.Key` '
                'method'
            ),
            new_description=(
        ...
        con_expression_shape_docs = DocumentModifiedShape(
            'ConditionExpression',
            new_type=(
                'condition from :py:class:`oss.dynamodb.conditions.Attr` '
                'method'
            ),
            new_description=(
