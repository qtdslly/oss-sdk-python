...
import oss
from oss.docs.client import Boto3ClientDocumenter
from oss.docs.resource import ResourceDocumenter, ServiceResourceDocumenter
from oss.utils import ServiceContext


class ServiceDocumenter(BaseServiceDocumenter):
    # The path used to find examples
    EXAMPLE_PATH = os.path.join(os.path.dirname(oss.__file__), 'examples')
