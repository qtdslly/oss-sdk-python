...
from oss.docs.action import document_action, document_load_reload_action
from oss.docs.attr import (
    document_attribute,
    document_identifier,
    document_reference,
)
from oss.docs.collection import (
    document_batch_action,
    document_collection_method,
    document_collection_object,
)
from oss.docs.subresource import document_sub_resource
from oss.docs.waiter import document_resource_waiter
