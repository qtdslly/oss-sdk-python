...
from oss.docs.action import ActionDocumenter
from oss.docs.attr import (
    document_attribute,
    document_identifier,
    document_reference,
)
from oss.docs.base import BaseDocumenter
from oss.docs.collection import CollectionDocumenter
from oss.docs.subresource import SubResourceDocumenter
from oss.docs.utils import (
    add_resource_type_overview,
    get_identifier_args_for_signature,
    get_identifier_description,
    get_identifier_values_for_example,
)
from oss.docs.waiter import WaiterResourceDocumenter
...
class ServiceResourceDocumenter(ResourceDocumenter):
    ...
    def _add_example(self, section, identifier_names):
        ...
        section.style.new_line()
        section.write(
            f'{self._service_name} = oss.resource(\'{self._service_name}\')'
        )
        section.style.end_codeblock()
