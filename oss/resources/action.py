...
from oss.docs.docstring import ActionDocstring
from oss.utils import inject_attribute
...
class ServiceAction:
    ...
    :type action_model: :py:class`~oss.resources.model.Action`
...
class BatchAction(ServiceAction):
    ...
    def __call__(self, parent, *args, **kwargs):
        ...
        :type parent:
            :py:class:`~oss.resources.collection.ResourceCollection`
...
class WaiterAction:
    ...
    :type waiter_model: :py:class`~oss.resources.model.Waiter`
