...
class ResourceFactory:
    """
    A factory to create new :py:class:`~oss.resources.base.ServiceResource`
    classes from a :py:class:`~oss.resources.model.ResourceModel`. There are
    ...
    def load_from_definition(
        ...
        :py:class:`~oss.resources.base.ServiceResource` subclass
        ...
        :rtype: Subclass of :py:class:`~oss.resources.base.ServiceResource`
    ...
    def _load_collections(self, attrs, resource_model, service_context):
        ...
        a :py:class:`~oss.resources.collection.CollectionManager` instance
