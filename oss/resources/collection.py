...
class ResourceCollection:
    ...
    def pages(self):
        ...
        :rtype: list(:py:class:`~oss.resources.base.ServiceResource`)
    ...
    def page_size(self, count):
        ...
        Fetch at most this many resources per service request.
            ...
            >>> for obj in s3.Bucket('oss').objects.page_size(100):
            ...     print(obj.key)
...
class CollectionManager:
    ...
    Get whole pages of items:
        ...
        >>> for page in s3.Bucket('oss').objects.pages():
        ...     for obj in page:
        ...         print(obj.key)
...
class CollectionFactory:
    ...
    subclasses from a :py:class:`~oss.resources.model.Collection`
